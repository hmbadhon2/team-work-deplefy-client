...
const Header = () => {
	...
	const manuItem = <>
		...
		{/* <li className="">
			<a rel="noopener noreferrer" href="" className="manu-item flex items-center px-4 -mb-1 font-bold text-gray-500 dark:hover:text-info">Analysis</a>
		</li> */}
	</>
   						...
   						<div>
							{
								user?.uid ? <div className="dropdown dropdown-end">
									<img tabIndex={1} className='h-12 rounded-full' src={user?.photoURL} alt="userImage" />
									<ul tabIndex={1} className="dropdown-content menu p-2  rounded-box w-52">
			...
			<div className="navbar bg-blue-50 dark:bg-black dark:text-white dark:border-b-2 dark:border-slate-900 lg:px-28 shadow">
				<div className="navbar-start">
					<div className="w-14 rounded">
						{
							theme === "dark" ? <img src="https://i.ibb.co/wWbLTRv/Untitled-design-2021-07-06-T142744-045-1-removebg-preview.png" /> : <img src="https://i.ibb.co/XkgWB8H/Perfect-unique-attractive-stylish-geometric-tech-PD-DP-P-D-initial-based-letter-icon-logo-removebg-p.png" />
						}
					</div>
