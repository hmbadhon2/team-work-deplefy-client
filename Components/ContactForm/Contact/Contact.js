            ...
            <section className="p-6 dark:text-gray-400">
                <div novalidate="" className="container md:w-96 bg-black max-w-xl mx-auto space-y-6 rounded-md shadow dark:bg-gray-900 ng-untouched ng-pristine ng-valid">
                    <div className="border-b-2 flex justify-between px-5 md:w-full text-white text-center py-5 border-white">
                        ...
                        <div className="flex">
                            <a href="https://meet.google.com/ykx-iukf-mru" target='_blank'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-4 text-pink-800">
                                <path strokeLinecap="round" d="M15.75 10.5l4.72-4.72a.75.75 0 011.28.53v11.38a.75.75 0 01-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25h-9A2.25 2.25 0 002.25 7.5v9a2.25 2.25 0 002.25 2.25z" />
                            </svg>
                            </a>
                            <a href="https://meet.google.com/ykx-iukf-mru" target='_blank'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-pink-800">
