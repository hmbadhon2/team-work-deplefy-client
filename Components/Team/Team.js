...
const Team = () => {
  ...
  return (
    <div className='my-4'>
      ...
      <div className='mx-3 p-8 md:w-2/3 lg:w-1/2 border border-gray-300'>
        {profileImage[0]?.teamName ? <h1 className=' text-xl md:text-3xl mb-3'>Settings for <span>Register {profileImage[0]?.teamName}</span></h1> : <h1 className=' text-lg md:text-3xl mb-3'>Settings for <span>Register team name</span></h1>}
