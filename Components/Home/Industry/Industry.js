...
const Industry = () => {
    return (
        <div className='px-4 md:px-0 py-24 bg-gradient-to-tr from-violet-900 to-blue-600 dark:bg-gradient-to-r dark:from-lime-900 dark:to-lime-500'>
        <div className='lg:max-w-3xl lg:mx-auto text-white'>
            ...
            <div className='md:flex items-center justify-around lg:text-3xl mt-8'>
