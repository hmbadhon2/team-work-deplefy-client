    ...
    return (
        <div className="py-10">
            <div className='text-center'>
                <p className='text-pink-800 font-bold text-xl'>Our Team</p>
                <h1 className="text-xl font-bold md:text-2xl">Meet With <span className='text-pink-800'>Our Team</span></h1>
            </div>
                ...
                <div className="flex flex-col justify-center p-4 mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        ...
                        <div className='bg-gray-300 shadow-lg'>
                            ...
                            <div className='pt-5 pl-2'>
                                <h1 className='text-pink-800 font-bold'>Lipton Barua</h1>
                                <p className='font-bold'>Team Member</p>
                            </div>
                            <div className="flex justify-start space-x-3 pt-3 pb-5 pl-2">
                        ...
                        <div className='bg-gray-300 shadow-lg'>
                            ...
                            <div className='pt-5 pl-2'>
                                <h1 className='text-pink-800 font-bold'>Milon Ahmed Shuvo</h1>
                                <p className='font-bold'>Team Member</p>
                            </div>
                            <div className="flex justify-start space-x-3 pt-3 pb-5 pl-2">
                                <a rel="noopener noreferrer" href="#" target="_blank" title="Facebook" className="flex items-center p-1">
                        ...
                        <div className='bg-gray-300 shadow-lg'>
                            ...
                            <div className='pt-5 pl-2'>
                                <h1 className='text-pink-800 font-bold'>Tamanna Rahman</h1>
                                <p className='font-bold'>Team Member</p>
                            </div>
                            <div className="flex justify-start space-x-3 pt-3 pb-5 pl-2">
                                <a rel="noopener noreferrer" href="#" target="_blank" title="Facebook" className="flex items-center p-1">
