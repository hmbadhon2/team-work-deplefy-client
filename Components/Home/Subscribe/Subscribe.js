        ...
        <div>
            <div className="flex flex-col items-center mb-20 ">
                ...
                <div className=" flex items-center mt-4">
                    ...
                    <button className="bg-gradient-to-tr from-violet-900  to-blue-600  text-white dark:bg-gradient-to-r dark:from-lime-900 dark:to-lime-500 dark:text-black font-bold py-3 px-6 rounded-lg">Subscribe</button>
