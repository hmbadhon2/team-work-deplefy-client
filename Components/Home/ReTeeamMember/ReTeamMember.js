...
const ReTeamMember = () => {
    return (
        ...
        <div class="row-span-1 bg-gradient-to-t to-blue-500 from-indigo-800 rounded-tl-[150px] rounded-br-[130px]">
        ...
        <div class="row-span-1 row-cols-1 md:row-span-2 md:col-span-2 bg-gradient-to-t to-blue-500 from-indigo-800 rounded-tl-[230px] rounded-br-[250px] my-32">
